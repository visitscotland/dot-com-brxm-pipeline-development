...
/**
 * A card that can contain images, text, video and info panels, which serves as a link. Generally
 * used in multiples that the user can browse through and navigate to.
 *
