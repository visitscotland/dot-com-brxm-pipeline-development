...
@HippoEssentialsGenerated(internalName = "visitscotland:SkiCentreList")
@Node(jcrType = "visitscotland:SkiCentreList")
public class SkiCentreList extends BaseDocument {
